<div class="sv-metabox">
    <div class="sv-inputs isActive">
        <label for="<?php echo esc_attr($slug); ?>_active"><?php echo _e('Publicar no Twitter?', 'sv-twitter'); ?></label>
    ...
    <div class="sv-inputs title">
        <label for="<?php echo esc_attr($slug); ?>_title"><?php echo _e('Título alternativo', 'sv-twitter'); ?></label>
