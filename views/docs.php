...
<div class="wrap sv-plugin docs">
    ...
    <p>
        <?php echo esc_html_e('O cadastro para uma conta de desenvolvedor é rápido e fácil!', 'sv-twitter'); ?>
