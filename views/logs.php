<div class="wrap sv-plugin">
    ...
    <p><?php echo esc_html_e('Aqui você pode acompanhar os logs das publicações', 'sv-twitter'); ?></p>
                ...
                <?php foreach($logs as $log) { ?>
                    <tr>
                        <td scope="col" class="manage-column column-post-id">
                            <a href="<?php echo esc_url(admin_url('post.php?post=' . $log['post_id'] . '&action=edit')); ?>" title="Go to Post"><?php echo esc_html_e($log['post_id']); ?></a>
                        </td>
                        <td scope="col" class="manage-column column-status"><?php echo esc_html_e($log['status'], 'sv-twitter'); ?></td>
                        <td scope="col" class="manage-column column-date"><?php echo esc_html_e(date('d/m/Y \a\s H:i:s', strtotime($log['date']))); ?></td>
                        <td scope="col" class="manage-column column-detalhes"><?php echo esc_html_e($log['message']); ?></td>
                    </tr>
                <?php } ?>
            </tbody>
            <tfoot>
